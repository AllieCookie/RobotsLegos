...
/*
	...
	public void tests2IA() throws BTcommConnectException, NXTCommException, IOException, InterruptedException {
		...
		//Victimes
		ArrayList<Victime> victimes = new ArrayList<>();
		Victime v1 = new Victime(1,1);
		Victime v2 = new Victime(0,4);
		Victime v3 = new Victime(2,3);
		Victime v4 = new Victime(4,1);
		Victime v5 = new Victime(1,2);
		...
		Hopital h1 = new Hopital(2,4);
		Hopital h2 = new Hopital(4,2);
		...
		Robot rob2=new Robot(c.findLigneElem(depart2), c.findColElem(depart2),TypeProtagoniste.robotHumain , "Glaedr");
		...
		//IArobot robot2 = new IArobot(c,depart2,pos2,"Shruikan","00:16:53:1C:19:95","Milson\n",rob2);
	...
	public void testsIAPlayer() throws BTcommConnectException, NXTCommException, IOException, InterruptedException {
		Carte c = carteExam();
		//Victimes
		ArrayList<Victime> victimes = new ArrayList<>();
